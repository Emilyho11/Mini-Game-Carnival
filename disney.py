...
def disneyScreen(gamewindow):
    ...
    background = pygame.transform.scale(pygame.image.load("disneyBackground.jpeg"), (1200, 800))
...
def disneyGuess(gamewindow):
    ...
    # If player did guessed 10 times, it is game over
        ...
        # Set Background - Using a picture
        overBackground = pygame.transform.scale(pygame.image.load("disneyBackground.jpeg"), (1200, 800))
